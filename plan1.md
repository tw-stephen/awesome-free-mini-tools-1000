...
| #006 | 文字反轉器 | 反轉整段文字或逐行反轉 | String.reverse | L1 | [ ] |
| #007 | 空白清理器 | 移除多餘空白、空行、首尾空白 | Regex, trim | L1 | [ ] |
| #008 | 換行轉換器 | 轉換 Windows/Unix/Mac 換行符號 | Regex | L1 | [ ] |
| #009 | 文字截取器 | 按字數或位元組截取文字 | String.slice | L1 | [ ] |
| #010 | 文字分割器 | 按分隔符號分割文字為多行 | String.split | L1 | [ ] |
