...
export default function PhotoFrameTool() {
  ...
  return (
    <div className="space-y-4">
      <div className="card p-4">
        <h2 className="text-lg font-semibold mb-1">Photo Frame</h2>
        <p className="text-sm text-slate-500 mb-4">Add photo frames to images</p>
        <textarea
