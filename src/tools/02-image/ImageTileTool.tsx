...
export default function ImageTileTool() {
  ...
  return (
    <div className="space-y-4">
      <div className="card p-4">
        <h2 className="text-lg font-semibold mb-1">Tile Repeater</h2>
        <p className="text-sm text-slate-500 mb-4">Tile an image to fill canvas</p>
        <textarea
