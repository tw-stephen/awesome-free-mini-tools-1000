...
export default function ImageShadowAdder() {
  ...
  return (
    <div className="space-y-4">
      <div className="card p-4">
        <h2 className="text-lg font-semibold mb-1">Shadow Adder</h2>
        <p className="text-sm text-slate-500 mb-4">Add drop shadow to images</p>
        <textarea
