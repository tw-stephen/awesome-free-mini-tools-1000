...
|-----|---------|---------|---------|-----|------|
| #001 | 大小寫轉換器 | 轉換文字大小寫（全大寫、全小寫、首字母大寫、句首大寫、交替大小寫） | String API | L1 | [x] |
| #002 | 文字計數器 | 計算字數、字元數、單詞數、句子數、段落數、閱讀時間 | Regex, String API | L1 | [x] |
| #003 | 文字比較器 | 比較兩段文字差異，高亮顯示不同處 | diff 演算法 | L2 | [x] |
| #004 | 重複文字移除 | 移除重複的行或單詞 | Set, Array | L1 | [x] |
| #005 | 文字排序工具 | 按字母、數字、長度排序文字行 | Array.sort | L1 | [x] |
...
| #016 | URL 編碼轉換 | URL 編碼與解碼 | encodeURI, decodeURI | L1 | [x] |
| #017 | Base64 編碼轉換 | Base64 編碼與解碼 | btoa, atob | L1 | [x] |
| #018 | 進位轉換器 | 二進位、八進位、十進位、十六進位互轉 | parseInt, toString | L1 | [x] |
| #019 | ASCII 藝術產生器 | 將文字轉換為 ASCII 藝術字 | figlet.js | L2 | [x] |
| #020 | 摩斯密碼轉換 | 文字與摩斯密碼互轉 | 對照表 | L1 | [x] |
| #021 | ROT13 加密 | ROT13 編碼與解碼 | String API | L1 | [x] |
| #022 | 豬拉丁文轉換 | 轉換為 Pig Latin | Regex | L1 | [x] |
| #023 | 全形半形轉換 | 全形與半形字元互轉 | charCode 轉換 | L1 | [x] |
