...
const pinyinMap: Record<string, string> = {
  ...
  '经': 'jīng', '头': 'tóu', '面': 'miàn', '事': 'shì', '把': 'bǎ', '最': 'zuì', '同': 'tóng', '从': 'cóng',
  ...
  '二': 'èr', '光': 'guāng', '期': 'qī', '觉': 'jiào', '城': 'chéng', '产': 'chǎn', '物': 'wù', '机': 'jī',
  ...
  '即': 'jí', '觉': 'jué', '特': 'tè', '党': 'dǎng', '建': 'jiàn', '求': 'qiú', '部': 'bù', '立': 'lì',
  ...
  '鸡': 'jī', '龙': 'lóng', '虎': 'hǔ', '蛇': 'shé', '兔': 'tù', '猴': 'hóu', '鼠': 'shǔ', '象': 'xiàng',
  '衣': 'yī', '帽': 'mào', '鞋': 'xié', '袜': 'wà', '裙': 'qún', '裤': 'kù', '衫': 'shān', '布': 'bù',
  '米': 'mǐ', '面': 'miàn', '饭': 'fàn', '菜': 'cài', '肉': 'ròu', '蛋': 'dàn', '奶': 'nǎi', '茶': 'chá',
  '酒': 'jiǔ', '糖': 'táng', '盐': 'yán', '油': 'yóu', '醋': 'cù', '汤': 'tāng', '饺': 'jiǎo', '饼': 'bǐng',
  '苹': 'píng', '果': 'guǒ', '香': 'xiāng', '蕉': 'jiāo', '桃': 'táo', '梨': 'lí', '葡': 'pú', '萄': 'táo',
  '橙': 'chéng', '瓜': 'guā', '柿': 'shì', '枣': 'zǎo', '杏': 'xìng', '李': 'lǐ', '桂': 'guì', '梅': 'méi',
  ...
  '爸': 'bà', '妈': 'mā', '爷': 'yé', '奶': 'nǎi', '哥': 'gē', '姐': 'jiě', '弟': 'dì', '妹': 'mèi',
  ...
  '酸': 'suān', '辣': 'là', '咸': 'xián', '淡': 'dàn', '香': 'xiāng', '臭': 'chòu', '美': 'měi', '丑': 'chǒu',
  ...
  '里': 'lǐ', '外': 'wài', '旁': 'páng', '底': 'dǐ', '顶': 'dǐng', '角': 'jiǎo', '弯': 'wān', '圆': 'yuán',
  ...
  '穿': 'chuān', '脱': 'tuō', '戴': 'dài', '摘': 'zhāi', '系': 'jì', '解': 'jiě', '扣': 'kòu', '挂': 'guà',
  '躺': 'tǎng', '蹲': 'dūn', '跪': 'guì', '踢': 'tī', '跳': 'tiào', '爬': 'pá', '滑': 'huá', '游': 'yóu',
  '骑': 'qí', '划': 'huá', '追': 'zhuī', '赶': 'gǎn', '逃': 'táo', '藏': 'cáng', '躲': 'duǒ', '玩': 'wán',
  '唱': 'chàng', '跳': 'tiào', '画': 'huà', '读': 'dú', '念': 'niàn', '背': 'bèi', '抄': 'chāo', '答': 'dá',
  '考': 'kǎo', '试': 'shì', '题': 'tí', '课': 'kè', '班': 'bān', '组': 'zǔ', '排': 'pái', '队': 'duì',
  '欢': 'huān', '喜': 'xǐ', '怒': 'nù', '哀': 'āi', '惧': 'jù', '惊': 'jīng', '恨': 'hèn', '羞': 'xiū',
  '慌': 'huāng', '急': 'jí', '静': 'jìng', '平': 'píng', '温': 'wēn', '柔': 'róu', '刚': 'gāng', '猛': 'měng',
  '拥': 'yōng', '抱': 'bào', '握': 'wò', '摸': 'mō', '捏': 'niē', '掐': 'qiā', '拍': 'pāi', '打': 'dǎ',
  ...
  '藏': 'cáng', '搜': 'sōu', '查': 'chá', '验': 'yàn', '测': 'cè', '量': 'liàng', '称': 'chēng', '秤': 'chèng',
  ...
  '輕': 'qīng', '軟': 'ruǎn', '寬': 'kuān', '頂': 'dǐng', '彎': 'wān', '圓': 'yuán', '斜': 'xié', '滾': 'gǔn',
  '擦': 'cā', '歡': 'huān', '喜': 'xǐ', '驚': 'jīng', '擁': 'yōng', '撕': 'sī', '織': 'zhī', '編': 'biān',
...
const removePinyin = (text: string): string => {
  if (!text) return ''
  // Remove parentheses format: 字(zì)
  let result = text.replace(/(.)\(([a-zA-Zāáǎàēéěèīíǐìōóǒòūúǔùǖǘǚǜ]+)\)/g, '$1')
  // Remove brackets format: 字[zì]
  result = result.replace(/(.)(\[)([a-zA-Zāáǎàēéěèīíǐìōóǒòūúǔùǖǘǚǜ]+)\]/g, '$1')
  // Remove ruby format
  result = result.replace(/<ruby>(.)<rp>\(<\/rp><rt>[^<]+<\/rt><rp>\)<\/rp><\/ruby>/g, '$1')
  return result
}
