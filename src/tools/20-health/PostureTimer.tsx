...
export default function PostureTimer() {
  ...
  return (
    <div className="space-y-4">
      <div className="card p-4">
        <h2 className="text-lg font-semibold mb-1">Posture Timer</h2>
        <p className="text-sm text-slate-500 mb-4">Remind to check posture regularly</p>
        <textarea
