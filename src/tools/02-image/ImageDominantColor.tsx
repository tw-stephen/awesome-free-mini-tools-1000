...
export default function ImageDominantColor() {
  ...
  return (
    <div className="space-y-4">
      <div className="card p-4">
        <h2 className="text-lg font-semibold mb-1">Dominant Color</h2>
        <p className="text-sm text-slate-500 mb-4">Find dominant colors in an image</p>
        <textarea
